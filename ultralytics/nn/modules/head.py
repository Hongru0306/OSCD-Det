...
from ..modules import Conv, DWConv
...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "I2P"
...
class Conv_GN(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True, use_gcd_group=False):
...
class I2P_HBB(nn.Module):
    ...
    def __init__(self, nc=80, hidc=256, ch=()):
        ...
        self.share_conv = nn.ModuleList([
             nn.Sequential(Conv_DPGN(hidc // 2, hidc // 2, 3),
                          Conv_DPGN(hidc, hidc // 2, 3), Conv_DPGN(2 * hidc, hidc // 2, 3)),
    ...
    def forward(self, x):
        """Concatenates and returns predicted bounding boxes and class probabilities."""
        for i in range(self.nl):
            stack_res_list = [self.share_conv[0][i](x[i])]
